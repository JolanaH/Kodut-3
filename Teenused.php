     ...
     <div class="row">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            ...
            <nav class="navbar navbar-expand-lg">    
              ...
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href=".html">Avaleht</a></li>
...
<div class="container mt-3"><div class="alert alert-danger" role="alert">Palun täitke kõik väljad ja nõustuge teenusetingimustega.</div></div>
